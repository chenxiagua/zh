...
export class BaseUploader {
    ...
    uploadMinidump(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._options.beforeSend && request.event) {
                ...
                const result = yield (isThenable(maybePromiseResult)
            ...
            try {
                ...
                try {
                    yield unlinkAsync(request.path);
    ...
    getNewMinidumps() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this._filterAsync(minidumps, (path) => __awaiter(this, void 0, void 0, function* () {
    ...
    _toMinidumpRequest(transport, event, minidumpPath) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!transport.isRateLimited('attachment')) {
                let minidumpContent = (yield readFileAsync(minidumpPath));
