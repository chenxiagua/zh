...
export class SentryMinidump {
    ...
    setupOnce() {
        ...
        forget(this._sendNativeCrashes(options, {
    ...
    _sendRendererCrash(options, contents, details) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const event = mergeEvents(yield getEventDefaults(release), {
                contexts: {
                    electron: {
    ...
    _sendChildProcessCrash(options, details) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const event = mergeEvents(yield getEventDefaults(options.release), {
                contexts: {
                    electron: { details },
                },
                level: Severity.Fatal,
