...
class OnUncaughtException {
    ...
    setupOnce() {
        ...
        global.process.on('uncaughtException', (error) => {
            ...
            if (self) {
                (0, core_1.getCurrentHub)().withScope((scope) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    scope.addEventProcessor((event) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                        return (Object.assign(Object.assign({}, event), { level: types_1.Severity.Fatal }));
                    }));
                    let theError = error;
                    if (!(0, utils_1.isError)(error) && error.stack) {
                        theError = new Error();
                    ...
                    nodeClient.captureException(theError, { originalException: error }, (0, core_1.getCurrentHub)().getScope());
