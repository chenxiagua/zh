...
const breakpad_uploader_1 = require("./breakpad-uploader");
const crashpad_uploader_1 = require("./crashpad-uploader");
...
class SentryMinidump {
    ...
    setupOnce() {
        ...
        const transport = client._getBackend().getTransport();
        this._uploader = (0, electron_normalize_1.usesCrashpad)()
            ? new crashpad_uploader_1.CrashpadUploader(options, transport)
            : new breakpad_uploader_1.BreakpadUploader(options, transport);
        ...
        (0, utils_1.forget)(this._sendNativeCrashes(options, {
            level: types_1.Severity.Fatal,
            platform: 'native',
    ...
    _sendRendererCrash(options, contents, details) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const event = (0, common_1.mergeEvents)(yield (0, context_1.getEventDefaults)(release), {
                contexts: {
                    electron: {
            ...
            const found = yield this._sendNativeCrashes(options, event);
            if (found) {
    ...
    _sendChildProcessCrash(options, details) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const event = (0, common_1.mergeEvents)(yield (0, context_1.getEventDefaults)(options.release), {
                contexts: {
                    electron: { details },
                },
                level: types_1.Severity.Fatal,
     ...
     */
    _sendNativeCrashes(options, event) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (paths.length > 0) {
                    const currentCloned = core_1.Scope.clone((0, core_1.getCurrentHub)().getScope());
                    ...
                    if (newEvent) {
                        ...
                        if (typeof sampleRate === 'number' && Math.random() > sampleRate) {
                            utils_1.logger.warn(`Discarding event because it's not included in the random sample (sampling rate = ${sampleRate})`);
                            return true;
                        }
                        if (newEvent && beforeSend) {
                            const beforeSendResult = yield this._ensureBeforeSendRv(beforeSend(event));
                            if (beforeSendResult === null) {
                                utils_1.logger.warn('`beforeSend` returned `null`, will not send event.');
                                return true;
                            }
                            newEvent = beforeSendResult;
                        }
                        paths.forEach((path) => {
                            (0, utils_1.forget)(uploader.uploadMinidump({ path, event: newEvent || {} }));
                        });
                    }
    ...
    _ensureBeforeSendRv(rv) {
        ...
        if ((0, utils_1.isThenable)(rv)) {
            return rv.then((event) => {
                if (!((0, utils_1.isPlainObject)(event) || event === null)) {
        ...
        else if (!((0, utils_1.isPlainObject)(rv) || rv === null)) {
            throw new utils_1.SentryError(nullErr);
        }
        return rv;
    }
