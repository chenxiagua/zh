...
class MainContext {
    ...
    setupOnce(addGlobalEventProcessor) {
        ...
        addGlobalEventProcessor((event) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const normalized = (0, common_1.normalizeEvent)(event, electron_1.app.getAppPath());
            const defaults = yield (0, context_1.getEventDefaults)(options === null || options === void 0 ? void 0 : options.release);
            const fullEvent = (0, common_1.mergeEvents)(defaults, normalized);
            return fullEvent;
        }));
    }
}
