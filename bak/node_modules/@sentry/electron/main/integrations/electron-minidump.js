...
function minidumpUrlFromDsn(dsn) {
    const { host, path, projectId, port, protocol, user } = (0, utils_1.makeDsn)(dsn);
...
class ElectronMinidump {
    ...
    setupOnce() {
        ...
        (0, utils_1.forget)((0, sessions_1.checkPreviousSession)(previousSessionCrashed));
    }
    /**
    ...
    _updateExtraParams(scope) {
        ...
        (0, utils_1.forget)(this._getNativeUploaderEvent(scope).then((event) => {
